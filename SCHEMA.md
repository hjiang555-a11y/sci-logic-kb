...
| `DERIVED-FROM` | subject 原理由 object 原理推导 | `pri.mirror_substrate_noise_dominance DERIVED-FROM pri.brownian_thermal_noise_fdt` |
...
> **突破路径不在关系里写**，而是在被引用的原理节点的 `condition_variables` 字段中。
