...
| 124 K (Si 第一零点 + **IBS** 镀层) | ~1×10⁻¹⁶ (Kessler 2012) | ~4×10⁻¹⁷ (若换 AlGaAs) | 5× | IBS 镀层 φ 主导 |
| 124 K (Si + **AlGaAs** 镀层) | 4×10⁻¹⁷ (Matei 2017) / 3.5×10⁻¹⁷ (Kedar 2023 Si5) | ~3×10⁻¹⁷ | 已达 | 进入 AlGaAs φ 地板 |
| 17 K (Si + AlGaAs) 🏆 | **2.5×10⁻¹⁷** (Lee 2026) / 5.5×10⁻¹⁷ (Kedar 2023 Si6 @16K) | ~1.5×10⁻¹⁷ | ~1.5× | AlGaAs 低温批次 φ |
| 4 K (Si + IBS) | 6.5×10⁻¹⁷ (Robinson 2019) / **4×10⁻¹⁷ (Chen 2025, 10 cm)** | ~few×10⁻¹⁸（若换 AlGaAs） | ~10× | 振动、镀层未升级至 AlGaAs |
...
|---------|---------|------|---------|---------|
| **124 K** | `ent.si_crystal_fp_cavity_k12` | Kessler 2012 | ~1×10⁻¹⁶ | Si CTE 第一零点，液氮可达，IBS 镀层 |
| **124 K** (+AlGaAs 镀层) | 同上 | Matei 2017 | 4×10⁻¹⁷（flicker floor 0.8–10 s）| 首次叠加晶体镀层 |
| **17 K** (+AlGaAs) | `ent.si_crystal_17k_fp_cavity_l26` | Lee 2026 | **2.5×10⁻¹⁷** 🏆 | Si CTE 第二零点，更低 φ |
| **4 K** | `ent.si_crystal_fp_cavity_4k_r19` | Robinson 2019 | 6.5×10⁻¹⁷（0.8–80 s） | 极低 φ，工程复杂度高 |
| **< 5 K** (10 cm) | `ent.si_crystal_fp_cavity_sub5k_c25` | Chen 2025 | 4(±1)×10⁻¹⁷ (4–12 s) | 10 cm 紧凑低温 |
| **16 K / 124 K 对比** | Kedar 2023 Si6/Si5 | 5.5×10⁻¹⁷ / 3.5×10⁻¹⁷ | 晶体镀层低温长期验证 | （阶段 C 新补关系）|
...
| 行 | 原页面声明 | YAML 实测 | 结论 |
|----|----------|---------|------|
| 124K + IBS 行 | "4×10⁻¹⁷" | Kessler 2012 实测 ~1×10⁻¹⁶（IBS）；Matei 2017 的 4×10⁻¹⁷ 用的是 AlGaAs | **已修正**（原页面把 Matei 的 AlGaAs 结果误贴到 IBS 行） |
| 124K + AlGaAs 行 | "~1×10⁻¹⁷（预期）" | 实际 Matei 2017 已达 4×10⁻¹⁷，Kedar 2023 Si5 达 3.5×10⁻¹⁷ | **已修正**（原"未达"描述不正确；已实现 3–4×10⁻¹⁷）|
| 4K 行 | "~4×10⁻¹⁷ (Chen 2025)" | Robinson 2019 已达 6.5×10⁻¹⁷ @ 4K；Chen 2025 为 4×10⁻¹⁷ @ <5K | **已补充**（Robinson 2019 应列入 4K 行）|
| §二 Robinson 2019 / Kedar 2023 列 | "—" | 两者 YAML 均有 mod σ_y 数据 | **已补入**（Robinson 6.5×10⁻¹⁷；Kedar 5.5/3.5×10⁻¹⁷ Si6/Si5 对比）|
| Lee 2026 17K σ_y | "2.5×10⁻¹⁷" | mod σ_y = 2.5×10⁻¹⁷（10 s flicker floor） | ✅ |
| Matei 2017 σ_y τ 限定 | 未标 | YAML: mod σ_y 在 0.8–10 s flicker floor | **已补 flicker floor 限定**|

**遗留动作**：
- [ ] 专家确认 Kedar 2023 应单列一行还是合并到 17K / 124K 现有行
- [ ] 考虑在"σ_y(1 s) 理论极限"列补参考文献（目前"~" 估计值缺溯源）
